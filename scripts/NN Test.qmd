...
data_cleaned <- data_dropped[, .('Fuel Type 2' = NULL, 'Engine Description' = NULL)]

# Fill missing values for numerical columns with their median
num_cols <- c('Engine Cylinders', 'Engine Displacement')
if (all(num_cols %in% names(data_cleaned))) {
