...
```{r child = paste0("sections/", c("introduction.qmd","data_description_html.qmd", "EDA_Uncleaned.qmd", "data_cleaning.qmd", "methods.qmd", "results_neural_network.qmd", "results_unsupervised_learning.qmd", "recommendations_and_discussion.qmd", "references.qmd", "annex.qmd"))}
```