...
```{r child = paste0('sections/', c('introduction.qmd', 'data_description_html.qmd', 'data_cleaning.qmd', 'results_classification_tree.qmd', 'results_neural_network.qmd', 'annex.qmd', 'references.qmd'))}
```