...
```{r child = paste0("sections/", c("introduction.qmd","data_description_html.qmd", "EDA_Uncleaned.qmd", "data_cleaning.qmd", "EDA_cleaned.qmd", "results_classification_tree.qmd", "results_neural_network.qmd", "recommendations_and_discussion.qmd", "references.qmd"))}
```