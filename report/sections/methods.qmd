...
-   Evaluate: The model's performance is evaluated using the validation set in each iteration.
Average Performance: The results from each iteration are averaged to provide a single performance metric.
