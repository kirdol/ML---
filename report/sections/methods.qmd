...
In addition, we decided to address class unbalances by Re-Sampling our dataset. We selected a threshold among our observation per make of 100 for not having brands with too little observations, then used the new dataset on our "base" Classification Tree.
