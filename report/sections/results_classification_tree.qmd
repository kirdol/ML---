...
With a number of fold of 10, we notice that our mean accuracy is approx. 70%, which is good. nevertheless, in order have a better model, we need to address overfitting. 
