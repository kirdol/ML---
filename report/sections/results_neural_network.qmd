...
history_no_dropout = model_no_dropout.fit(X_train, y_train, epochs=100, batch_size=32, validation_split=0.2, verbose=0)
...
# Train the model with class weights
history_no_dropout = model_no_dropout2.fit(X_train, y_train, epochs=100, batch_size=32, validation_split=0.2, class_weight=class_weights_dict, verbose=0)
...
for rate in dropout_rates:
    ...
    history = model.fit(X_train_split, y_train_split, epochs=100, batch_size=32, class_weight=class_weights_dict, verbose=0)
...
# Train the model and collect training accuracy
history = model.fit(X_train_split,y_train_split, epochs=100, batch_size=32, class_weight=class_weights_dict, validation_data=(X_val, y_val), verbose=0)
