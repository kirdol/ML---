...
=======
Then, we proceed with the calculation of the Total Within-Cluster Sum of Squares (TWCSS) and visualize the results using the Elbow method in order to select the optimal number of clusters.
>>>>>>> Stashed changes
