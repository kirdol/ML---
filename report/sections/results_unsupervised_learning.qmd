...
# Elbow Graph
elbow_plot <- plot_ly(x = 1:10, y = wcss, type = 'scatter', mode = 'lines+markers',
                      marker = list(color = 'blue')) %>%
  layout(title = "Elbow Method for Determining Optimal Number of Clusters",
         xaxis = list(title = "Number of Clusters"),
         yaxis = list(title = "Within-Cluster Sum of Squares (WCSS)"))
